...
class NomadJSONProtocol(TSimpleJSONProtocol):
    FIELD_NAMES_TRANSLATIONS = {
        # "args" is a reseved word in thrift and therefore cannot be used as
        # a field name.
        "command_args": "args",
        # "class" is a reseved word in thrift and therefore cannot be used as
        # a field name.
        "java_class": "class",
    }
    ...
    def writeBool(self, boolean):
        # This will make writeBool writing a json compatible boolean instead
        # of 1/0
        s = "false"
        if boolean:
            s = "true"
